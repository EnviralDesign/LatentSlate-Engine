...
| [Wan 2.2 14B](./WAN22_14B.md) | Matching official dense BF16 T2V or I2V expert pair | None | Official LightX2V I2V four-step pair, then Winnougan INT8 ConvRot investigation | Active shift-5 exact I2V baseline, materialization cancellation, and fresh recovery accepted; **Experimental** | Qualify LightX2V/INT8 as separate operations; complete corpus, source-invalidation, peer-switch, and BF16-reference evidence |
