...
| [Wan 2.2 14B](./WAN22_14B.md) | Matching official dense BF16 T2V or I2V expert pair | None; the active shift-5 Comfy FP8 I2V baseline is **Fallback** | Winnougan INT8 ConvRot investigation; LightX2V is accepted separately as **Experimental** | Exact baseline plus LightX success, denoise cancellation, fresh recovery, native LoRA dispatch, and disposable-worker teardown accepted | Complete corpus, source-invalidation, peer-switch, and BF16-reference quality evidence before promoting either I2V path |
