...
| [LTX 2.3](./LTX_2_3.md) | Engine-native optimized T2V/I2V and separate FLF | BF16 structural Reference; optimized path not implemented | exact closures and Engine-native Kitchen runtimes |
