...
| [LTX 2.3](./LTX_2_3.md) | Native Distilled BF16 structural reference only | None | Official Comfy Dev FP8 + Distilled LoRA T2V/I2V and Distilled FP8 FLF | Native BF16 and three optimized Comfy operations are cataloged with CPU/source contracts; hardware acceptance pending | Run operation-specific cold output/cancel/recovery acceptance; defer dense BF16 evidence to Vast |
