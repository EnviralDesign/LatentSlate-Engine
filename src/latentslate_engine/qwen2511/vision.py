"""Qwen 2.5 VL vision encoder, narrowly adapted from ComfyUI
12d5279438bfefc058a269eae805ceab6047777f text_encoders/qwen_vl.py (GPL-3.0).
Only direct Torch attention replaces the reference runtime dispatch.
"""
