"""Mapped safetensors views shared by the measured Krea and Qwen image paths.

Narrowly adapted from pinned ComfyUI 12d5279438bfefc058a269eae805ceab6047777f
comfy/utils.py (GPL-3.0). AIMDO owns the mapping and transfer primitives.
"""
...
class MappedCheckpoint:
    """Keep a safetensors checkpoint mapped while its weights are staged."""
