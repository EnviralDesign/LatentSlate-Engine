...
from .prefetch import make_prefetch_queue, prefetch_queue_pop
    ...
    def forward(
        ...
        if run_vx:
            ...
            if False:
                ...
                norm_vx = ck.rms_adaln(vx, vscale_msa, vshift_msa)
        ...
        if run_a2v or run_v2a:
            ...
            if run_a2v:
                ...
                if False:
                    vx_scaled = rms_norm(vx) * (1 + scale_ca_video_hidden_states_a2v_v) + shift_ca_video_hidden_states_a2v_v
                else:
                    vx_scaled = ck.rms_adaln(vx, scale_ca_video_hidden_states_a2v_v, shift_ca_video_hidden_states_a2v_v)
            ...
            if run_v2a:
                ...
                if False:
                    vx_scaled = rms_norm(vx) * (1 + scale_ca_video_hidden_states_v2a) + shift_ca_video_hidden_states_v2a
                else:
                    vx_scaled = ck.rms_adaln(vx, scale_ca_video_hidden_states_v2a, shift_ca_video_hidden_states_v2a)
        ...
        if run_vx:
            ...
            if False:
                ...
                vx_scaled = ck.rms_adaln(vx, vscale_mlp, vshift_mlp)
...
class LTXAVModel(LTXVModel):
    ...
    def _process_transformer_blocks(
        ...
        prefetch_queue = make_prefetch_queue(list(self.transformer_blocks), vx.device, transformer_options)
        ...
        for i, block in enumerate(self.transformer_blocks):
            prefetch_queue_pop(prefetch_queue, vx.device, block)
        ...
        prefetch_queue_pop(prefetch_queue, vx.device, None)
