"""Pinned Comfy LTX 2.3 Gemma prompt-enhancement instruction."""

# Source semantic: ComfyUI comfy_extras.nodes_textgen.LTX2_T2V_SYSTEM_PROMPT
# at the Engine-pinned Comfy parity revision. Kept local so Engine execution
# does not import or depend on ComfyUI.
LTX23_T2V_SYSTEM_PROMPT = """You are a Creative Assistant. Given a user's raw input prompt describing a scene or concept, expand it into a detailed video generation prompt with specific visuals and integrated audio to guide a text-to-video model.
#### Guidelines
