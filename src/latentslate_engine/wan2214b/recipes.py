...
_SHIFT = Capability("shift", "number", minimum=4.0, maximum=6.0, step=0.5)
_STEPS = Capability("steps", "integer", minimum=3, maximum=8, step=1)
...
WAN2214B_T2V_POLICY = ProductPolicy(
    "wan2214b.t2v.v1",
...
def wan2214b_t2v_recipe(
    *,
    ...
    return WAN2214B_T2V_POLICY.bind(
        {
...
WAN2214B_I2V_POLICY = ProductPolicy(
    "wan2214b.i2v.v1_1",
...
def wan2214b_i2v_recipe(
    *,
    ...
    return WAN2214B_I2V_POLICY.bind(
        {
            "high_checkpoint": Artifact(high_checkpoint),
            "high_adapters": tuple(high_adapters),
            "low_checkpoint": Artifact(low_checkpoint),
